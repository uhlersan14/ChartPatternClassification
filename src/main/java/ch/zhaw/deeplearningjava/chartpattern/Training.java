...
/**
 * Training class for chart pattern recognition
 */
public final class Training {
    ...
    public static void main(String[] args) throws IOException, TranslateException {
        ...
        //     ...
        //   etc.
        ImageFolder dataset = initDataset("chart-patterns");
        
        // Split the dataset set into training dataset and validate dataset (80% training, 20% validation)
        RandomAccessDataset[] datasets = dataset.randomSplit(8, 2);

        // set loss function
        Loss loss = Loss.softmaxCrossEntropyLoss();

        // setting training parameters (hyperparameters)
        ...
        System.out.println("Training completed. Model saved to: " + modelDir.toString());
        System.out.println("Classes: " + dataset.getSynset());
    }
